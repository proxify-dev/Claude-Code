...
### CLAUDE.md
Project-level context that persists across every session. Commands, architecture, conventions, warnings. See the [CLAUDE.md guide](claude-md-guide.md).

### Skills
Domain knowledge that loads when relevant. Instead of explaining your testing philosophy every session, encode it in a skill. See the [skills quickstart](skills-quickstart.md).
