...
<CardGroup cols={2}>
  <Card title="Skills Overview" href="/skills/overview/">The three-level loading model and how skills work.</Card>
  <Card title="Using Skills" href="/skills/using-skills/">Install, browse, and configure skills.</Card>
  <Card title="Creating Skills" href="/skills/creating-skills/">Anatomy, SKILL.md format, and first steps.</Card>
  <Card title="Distributing Skills" href="/skills/distributing-skills/">Share skills via GitHub and skills.sh.</Card>
</CardGroup>

## Agents

<CardGroup cols={2}>
  <Card title="Creating Agents" href="/agents/creating-agents/">Frontmatter, system prompts, model selection, MCP config.</Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Shortcuts & Commands" href="/reference/shortcuts/">Slash commands, keyboard shortcuts, CLI flags.</Card>
</CardGroup>
